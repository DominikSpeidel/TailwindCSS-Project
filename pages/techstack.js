    ...
    <>
      ...
      <div>
        ...
        <section className="mt-8 text-lg leading-relaxed text-gray-800">
          <p className="mb-6">
            "Tischlein Deck Dich" wurde als Projekt zum Erlernen von Tailwind
            CSS und responsivem Design konzipiert. Zunächst als kleine Übungsapp
            ...
            Familienkreis herangezogen zu werden. Als Teil meines
            Projektportfolios werde ich Tischlein Deck Dich in den nächsten
            Wochen und Monaten weiterentwickeln und neue Features aus
            Lernzwecken implementieren.
          </p>
          <p className="mb-6">
